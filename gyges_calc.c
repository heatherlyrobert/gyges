...
tERROR*      /*-> create a single error entry --------[ leaf   [gp.A60.133.80]*/ /*-[11.0000.016.!]-*/ /*-[--.---.---.--]-*/
...
char         /*-> destroy a single error entry -------[ leaf   [gc.530.102.80]*/ /*-[10.0000.016.!]-*/ /*-[--.---.---.--]-*/
...
char         /*-> tbd --------------------------------[ ------ [gc.530.611.11]*/ /*-[00.0000.0J5.!]-*/ /*-[--.---.---.--]-*/
...
char         /*-> tbd --------------------------------[ ------ [ge.530.142.21]*/ /*-[01.0000.105.!]-*/ /*-[--.---.---.--]-*/
...
char         /*-> tbd --------------------------------[ leaf   [ge.A61.365.60]*/ /*-[02.0000.104.!]-*/ /*-[--.---.---.--]-*/
...
char         /*-> tbd --------------------------------[ leaf   [gz.980.041.70]*/ /*-[01.0000.104.!]-*/ /*-[--.---.---.--]-*/
ERROR_list         (void)
{
   /*---(locals)-----------+-----------+-*/
   tERROR     *x_error     = NULL;
...
PRIV void    /*-> tbd --------------------------------[ ------ [fv.530.010.42]*/ /*-[20.0000.003.!]-*/ /*-[--.---.---.--]-*/
CALC__find         (void)
{
   char       *rcp         = NULL;
   /*---(get arguments)------------------*/
...
PRIV void    /*-> find max of all numeric cells ------[ leaf   [fv.A52.040.70]*/ /*-[03.0000.02#.!]-*/ /*-[--.---.---.--]-*/
...
PRIV void    /*-> total all numeric cells ------------[ ------ [fv.211.000.12]*/ /*-[00.0000.00#.!]-*/ /*-[--.---.---.--]-*/
CALC__sum          (void)
{
...
PRIV void    /*-> count all numeric cells ------------[ ------ [fv.211.000.12]*/ /*-[00.0000.00#.!]-*/ /*-[--.---.---.--]-*/
CALC__count        (void)
{
   DEBUG_CALC   yLOG_enter   (__FUNCTION__);
   SHARED__gather (__FUNCTION__);
...
PRIV void    /*-> average all numeric cells ----------[ ------ [fv.311.000.32]*/ /*-[01.0000.00#.!]-*/ /*-[--.---.---.--]-*/
CALC__average      (void)
{
   DEBUG_CALC   yLOG_enter   (__FUNCTION__);
   SHARED__gather (__FUNCTION__);
...
PRIV void    /*-> find min of all numeric cells ------[ ------ [fv.211.000.12]*/ /*-[00.0000.00#.!]-*/ /*-[--.---.---.--]-*/
CALC__minimum      (void)
{
   DEBUG_CALC   yLOG_enter   (__FUNCTION__);
   SHARED__gather (__FUNCTION__);
...
PRIV void    /*-> find max of all numeric cells ------[ ------ [fv.211.000.12]*/ /*-[00.0000.00#.!]-*/ /*-[--.---.---.--]-*/
CALC__maximum      (void)
{
   DEBUG_CALC   yLOG_enter   (__FUNCTION__);
   SHARED__gather (__FUNCTION__);
...
char         /*-> initialize calculation capability --[ shoot  [gz.CA0.071.B3]*/ /*-[02.0000.102.!]-*/ /*-[--.---.---.--]-*/
CALC_init            (void)
{
   /*---(locals)-----------+-----------+-*/
   int         i, j;
...
char         /*-> free an existing calculation -------[ leaf   [gc.420.122.30]*/ /*-[21.0000.415.!]-*/ /*-[--.---.---.--]-*/
...
char         /*-> handle ranges in rpn ---------------[ ------ [ge.D94.1C#.B2]*/ /*-[01.0000.018.!]-*/ /*-[--.---.---.--]-*/
CALC_range         (
      /*----------+-----------+-----------------------------------------------*/
...
char         /*-> interpret a pointer ----------------[ leaf   [ge.I97.17#.C0]*/ /*-[01.0000.018.!]-*/ /*-[--.---.---.--]-*/
CALC_pointer       (
      /*----------+-----------+-----------------------------------------------*/
      tCELL      *a_cell,     /* cell owning the calculation                  */
      tCALC      *a_calc)     /* current token                                */
...
char         /*-> clear an existing calculation ------[ ------ [gz.320.101.22]*/ /*-[01.0000.018.!]-*/ /*-[--.---.---.--]-*/
CALC_cleanse       (
      /*----------+-----------+-----------------------------------------------*/
      tCELL      *a_cell)     /* cell owning the calculation                  */
{  /*---(design notes)--------------------------------------------------------*/
