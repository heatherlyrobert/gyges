...
api_ymap_done           (void)
{
   ...
   if (x_curr == NULL || x_curr->d_source == NULL) {
      ...
      ystrlcpy (g_curr.h_pros_plus, "n/a", LEN_RECD);
      ystrlcpy (g_curr.h_reqs_plus, "n/a", LEN_RECD);
   ...
   yCALC_disp_prosplus (x_curr->d_ycalc, g_curr.h_pros_plus);
   yCALC_disp_reqsplus (x_curr->d_ycalc, g_curr.h_reqs_plus);
