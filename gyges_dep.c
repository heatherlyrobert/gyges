 ...
 *>       DEP_disp_sort  (temp);                                                                                                                             <* 
 *>       if (x_cell != NULL)  snprintf(unit_answer, LEN_UNIT, "s_dep requires   : %-5.5s (%2d) %-.35s", x_cell->label, yCALC_nreq (x_cell->ycalc), temp);   <* 
 ...
 *>       DEP_disp_sort  (temp);                                                                                                                             <* 
 *>       if (x_cell != NULL)  snprintf(unit_answer, LEN_UNIT, "s_dep provides   : %-5.5s (%2d) %-.35s", x_cell->label, yCALC_npro (x_cell->ycalc), temp);   <* 
